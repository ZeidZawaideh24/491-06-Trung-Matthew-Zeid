...
def config_event():
	...
	if len(CONFIG.extra) > 0:
		...
		match CONFIG.extra[0]:
			...
			case _:
				print("Unknown command. List of commands:")
				print("set_account <email> <password>")
				print("  Set account with email and password.")
				print("get_account <email> <password>")
				print("  Get account with email and password.")
				print("del_account <email> <password>")
				print("  Delete account with email and password.")
				print("set_site_account <memba_id> <site_id> <data>")
				print("  Configure site account with memba_id, site_id and data.")
				print("get_site_account <memba_id> <site_id> <user_id>")
				print("  Get site account details.")
				print("get_site_account_all <memba_id> <site_id>")
				print("  Get all site accounts associated with memba_id and site_id.")
				print("del_site_account <memba_id> <site_id> <user_id>")
				print("  Delete site account with memba_id, site_id and user_id.")
				print("set_site_data <memba_id> <site_id> <user_id> <data>")
				print("  Set site data with memba_id, site_id, user_id and data.")
				print("get_site_data <memba_id> <site_id> <user_id>")
				print("  Get site data with memba_id, site_id and user_id.")
				print("del_site_data <memba_id> <site_id> <user_id>")
				print("  Delete site data with memba_id, site_id and user_id.")
				print("set_track <memba_id> <site_id> <user_id> <data>")
				print("  Set schedule with memba_id, site_id, user_id and data.")
				print("get_track <memba_id> <site_id> <user_id>")
				print("  Get schedule with memba_id, site_id and user_id.")
				print("del_track <memba_id> <site_id> <user_id>")
				print("  Delete schedule with memba_id, site_id and user_id.")